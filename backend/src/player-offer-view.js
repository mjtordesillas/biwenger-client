...
// player view, plus the offer amount, when it expires, and, where
// identifiable, who made it. Unlike market-listing-view.js there's no
// separate asking price to track alongside the catalogue value —
