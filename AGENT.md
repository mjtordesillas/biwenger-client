...
- Deliver whatever feature is chosen next as the thinnest possible complete vertical slice (Elephant Carpaccio). See `docs/ways-of-working/vertical-slicing.md`. Feature selection itself is not this rule's concern — see `docs/backlog.md`.
...
- `docs/ways-of-working/` — git workflow, vertical slicing, testing strategy, test-refactoring, concerns guide
