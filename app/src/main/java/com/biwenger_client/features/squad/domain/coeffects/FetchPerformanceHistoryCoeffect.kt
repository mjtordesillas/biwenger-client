...
data class FetchPerformanceHistoryCoeffect(val playerId: Int) : Coeffect<PerformanceHistory>
...
class FetchPerformanceHistoryCoeffectHandler(
    ...
    override suspend fun extract(coeffect: FetchPerformanceHistoryCoeffect): PerformanceHistory =
        when (val result = performanceHistoryService.performanceHistory(coeffect.playerId)) {
